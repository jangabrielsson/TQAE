...
Installation
First time download the archive, TQAE.tar.gz and unpack it in a suitable directory on your PC/Mac/Linux.
On Linux:
```
...
first.thumb.png.462ec773b1ea91afe668c5c6ff73321e.png
 
Goto [Settings] in the web page menu (upper right).
second.thumb.png.53e3420e6d47f4e160b67d902bd65416.png
