...
local interpreter = {
  ...
  return {
    name = "TQAE support",
    description = "Support for TQAE emulator and templates.",
    ...
    onRegister = function()
      ...
      menu:Append(idem, "TQAE Emulator\tCtrl-Alt-E"..KSC(idem))
      ...
      addLinkHelp("TQAE emulator help",urlHC3Help)
...
--      ide:GetMainFrame():Connect(idech3, wx.wxEVT_COMMAND_MENU_SELECTED, launchHC3Copy)
      ...
      templ = menu:AppendSubMenu(templSubMenu, TR("TQAE templates..."))
